...
def verify_05269061(I: Grid) -> Grid:
    ...
    x15 = chain(x4, x11, x14)
    x16 = apply(x12, x2)
    x17 = apply(x15, x3)
    x18 = combine(x16, x17)
    x19 = rbind(shoot, NEG_UNITY)
    x20 = chain(x4, x19, x14)
    x21 = rbind(astuple, x13)
    x22 = lbind(subtract, x13)
    x23 = compose(x21, x22)
    x24 = chain(x4, x19, x23)
    x25 = apply(x20, x2)
    x26 = apply(x24, x3)
    x27 = combine(x25, x26)
    x28 = rbind(valmax, numcolors)
    x29 = matcher(x28, ONE)
    x30 = x29(x9)
    x31 = x29(x10)
    x32 = x29(x18)
    x33 = branch(x32, x18, x27)
    x34 = branch(x31, x10, x33)
    x35 = branch(x30, x9, x34)
    x36 = apply(mostcolor, x35)
    x37 = matcher(identity, ZERO)
    ...
    x42 = divide(x41, x40)
    x43 = increment(x42)
    x44 = interval(ZERO, x43, ONE)
    x45 = matcher(first, ZERO)
    x46 = compose(flip, x45)
    x47 = fork(recolor, first, last)
    x48 = size(x35)
    x49 = interval(ZERO, x48, ONE)
    x50 = rbind(compose, first)
    x51 = lbind(rbind, greater)
    x52 = chain(x50, x51, decrement)
    x53 = lbind(apply, last)
    x54 = lbind(chain, x53)
    x55 = rbind(x54, x52)
    x56 = lbind(lbind, sfilter)
    x57 = lbind(pair, x49)
    x58 = chain(x55, x56, x57)
    x59 = x58(x35)
    x60 = x58(x36)
    x61 = rbind(multiply, x40)
    x62 = compose(x59, x61)
    x63 = compose(x60, x61)
    x64 = lbind(mapply, x47)
    x65 = rbind(sfilter, x46)
    x66 = lbind(pair, x36)
    x67 = compose(x66, x62)
    x68 = chain(x64, x65, x67)
    x69 = rbind(pair, x35)
    x70 = compose(x69, x63)
    x71 = chain(x64, x65, x70)
    x72 = fork(combine, x68, x71)
    x73 = mapply(x72, x44)
    x74 = paint(I, x73)
    return x74
...
def verify_1b60fb0c(I: Grid) -> Grid:
    ...
    x33 = chain(size, x32, x20)
    x34 = argmax(x31, x33)
    x35 = shift(x7, x34)
    x36 = difference(x35, x1)
    x37 = fill(I, TWO, x36)
    return x37
...
def verify_2204b7a8(I: Grid) -> Grid:
    ...
    x18 = remove(x14, x17)
    x19 = first(x18)
    x20 = replace(x8, x19, x10)
    x21 = branch(x4, dmirror, identity)
    x22 = branch(x4, height, width)
    x23 = x22(I)
    x24 = astuple(ONE, x23)
    x25 = canvas(x14, x24)
    x26 = x21(x25)
    x27 = replace(x9, x19, x13)
    x28 = x7(x20, x26)
    x29 = branch(x4, width, height)
    x30 = x29(I)
    x31 = even(x30)
    x32 = branch(x31, x20, x28)
    x33 = x7(x32, x27)
    return x33
...
def verify_22eb0ac0(I: Grid) -> Grid:
    ...
    x21 = fork(connect, x19, x20)
    x22 = fork(recolor, x7, x21)
    x23 = height(I)
    x24 = width(I)
    ...
    x32 = fork(either, x29, x31)
    x33 = toindices(x4)
    x34 = sfilter(x33, x28)
    x35 = equality(x33, x34)
    x36 = mapply(x22, x18)
    x37 = paint(I, x36)
    x38 = branch(x35, x28, x32)
    x39 = asindices(I)
    x40 = sfilter(x39, x38)
    x41 = toobject(x40, I)
    x42 = paint(x37, x41)
...
def verify_234bbc79(I: Grid) -> Grid:
    ...
    x35 = fork(remove, x32, x31)
    x36 = compose(x34, x35)
    x37 = compose(initset, x32)
    x38 = chain(x19, x20, x37)
    x39 = fork(argmin, x36, x38)
    x40 = compose(first, x39)
    x41 = compose(last, x32)
    x42 = fork(astuple, x40, x41)
    x43 = fork(insert, x42, x35)
    x44 = rbind(shift, RIGHT)
    x45 = fork(subtract, x24, x41)
    x46 = fork(shift, x43, x45)
    x47 = compose(x44, x46)
    x48 = fork(combine, x27, x47)
    x49 = fork(remove, x31, last)
    x50 = fork(astuple, x48, x49)
    x51 = decrement(x9)
    x52 = power(x50, x51)
    x53 = first(x1)
    x54 = remove(x53, x1)
    ...
    x62 = width(x57)
    x63 = astuple(x61, x62)
    x64 = crop(x60, ORIGIN, x63)
    x65 = ofcolor(x64, x14)
    x66 = mostcolor(I)
    x67 = palette(x64)
    x68 = contained(x14, x67)
    x69 = matcher(first, x66)
    x70 = compose(flip, x69)
    x71 = rbind(sfilter, x70)
    x72 = mapply(dneighbors, x65)
    x73 = lbind(toobject, x72)
    x74 = compose(x71, x73)
    x75 = rbind(recolor, x65)
    x76 = chain(x75, mostcolor, x74)
    x77 = fork(paint, identity, x76)
    x78 = branch(x68, x77, identity)
    x79 = x78(x64)
    return x79
...
def verify_239be575(I: Grid) -> Grid:
    ...
    x18 = remove(x12, x17)
    x19 = first(x18)
    x20 = colorfilter(x0, x19)
    x21 = rbind(adjacent, x15)
    x22 = rbind(adjacent, x16)
    x23 = fork(both, x21, x22)
    x24 = sfilter(x20, x23)
    x25 = size(x24)
    x26 = positive(x25)
    x27 = branch(x26, x19, ZERO)
...
def verify_25d487eb(I: Grid) -> Grid:
    ...
    x3 = compose(x1, mostcolor)
    x4 = fork(extract, identity, x2)
    x5 = compose(last, x4)
    x6 = compose(dneighbors, x5)
    x7 = lbind(apply, last)
    x8 = fork(sfilter, identity, x3)
    x9 = compose(x7, x8)
    x10 = fork(difference, x6, x9)
    x11 = compose(first, x10)
    x12 = fork(subtract, x5, x11)
    x13 = fork(shoot, x5, x12)
    x14 = fork(recolor, leastcolor, x13)
    x15 = mapply(x14, x0)
    x16 = underpaint(I, x15)
    return x16
...
def verify_264363fd(I: Grid) -> Grid:
    ...
    x30 = compose(x28, x29)
    x31 = power(outbox, TWO)
    x32 = chain(backdrop, x31, initset)
    x33 = fork(difference, x30, x32)
    x34 = lbind(recolor, x23)
    x35 = compose(x34, x33)
    x36 = lbind(shift, x25)
    x37 = fork(combine, x35, x36)
    x38 = lbind(mapply, x37)
    x39 = rbind(ofcolor, x21)
    x40 = compose(x38, x39)
    x41 = fork(paint, identity, x40)
    x42 = rbind(subgrid, I)
    x43 = chain(asobject, x41, x42)
    x44 = fork(shift, x43, ulcorner)
    x45 = mapply(x44, x11)
    x46 = paint(x9, x45)
    return x46
...
def verify_27a28665(I: Grid) -> Grid:
    ...
    x32 = equality(x30, FOUR)
    x33 = equality(x30, FIVE)
    x34 = branch(x31, TWO, ONE)
    x35 = branch(x32, THREE, x34)
    x36 = branch(x33, SIX, x35)
    x37 = canvas(x36, UNITY)
    return x37
...
def verify_28e73c20(I: Grid) -> Grid:
    ...
    x20 = identity(F)
    x21 = identity(ZERO)
    x22 = compose(first, first)
    x23 = chain(first, last, x22)
    x24 = chain(last, last, x22)
    x25 = chain(first, first, first)
    x26 = chain(first, last, last)
    x27 = chain(first, first, last)
    x28 = chain(last, first, last)
    x29 = compose(decrement, x23)
    x30 = compose(decrement, x24)
    x31 = fork(astuple, x29, x30)
    x32 = fork(multiply, x27, x30)
    x33 = fork(add, x26, x32)
    x34 = compose(decrement, x25)
    x35 = fork(multiply, x27, x34)
    x36 = fork(add, x26, x35)
    x37 = fork(astuple, x36, x33)
    x38 = lbind(extract, x6)
    x39 = lbind(matcher, first)
    x40 = compose(x39, x27)
    x41 = chain(last, x38, x40)
    x42 = compose(last, first)
    x43 = lbind(recolor, THREE)
    x44 = fork(connect, x26, x36)
    x45 = compose(x43, x44)
    x46 = fork(paint, x42, x45)
    x47 = fork(multiply, x28, x30)
    x48 = compose(flip, x28)
    x49 = fork(multiply, x48, x29)
    x50 = fork(add, x47, x49)
    x51 = power(first, THREE)
    x52 = chain(flip, positive, x51)
    x53 = fork(astuple, x50, x31)
    x54 = fork(astuple, x41, x48)
    x55 = fork(astuple, x53, x46)
    x56 = fork(astuple, x54, x37)
    x57 = fork(astuple, x55, x56)
    x58 = rbind(branch, x57)
    x59 = rbind(x58, identity)
    x60 = chain(initset, x59, x52)
    x61 = fork(rapply, x60, identity)
    x62 = compose(first, x61)
    x63 = multiply(TEN, THREE)
    x64 = power(x62, x63)
    x65 = astuple(x18, x19)
    x66 = astuple(x15, x20)
    x67 = astuple(x14, x21)
...
def verify_2c608aff(I: Grid) -> Grid:
    ...
    x17 = ofcolor(I, x8)
    x18 = sfilter(x17, x16)
    x19 = rbind(gravitate, x3)
    x20 = compose(x19, initset)
    x21 = fork(add, identity, x20)
    x22 = fork(connect, identity, x21)
    x23 = mapply(x22, x18)
    x24 = fill(I, x8, x23)
    return x24
...
def verify_2dc579da(I: Grid) -> Grid:
    ...
    x36 = apply(x35, x33)
    x37 = matcher(numcolors, ONE)
    x38 = sfilter(x36, x37)
    x39 = apply(color, x38)
    x40 = mostcommon(x39)
    x41 = initset(x40)
    x42 = matcher(palette, x41)
...
def verify_2dd70a9a(I: Grid) -> Grid:
    ...
    x53 = extract(x47, x52)
    x54 = x46(x53)
    x55 = fork(either, hline, vline)
    x56 = lbind(connect, x6)
    x57 = corners(x54)
    x58 = apply(x56, x57)
    x59 = mfilter(x58, x55)
    x60 = lbind(connect, x8)
    x61 = apply(x60, x57)
    x62 = mfilter(x61, x55)
    x63 = combine(x59, x62)
    x64 = combine(x54, x63)
    x65 = fill(x3, THREE, x64)
    x66 = fill(x65, TWO, x5)
    x67 = x2(x66)
    return x67
...
def verify_3345333e(I: Grid) -> Grid:
    ...
    x39 = chain(size, x38, x34)
    x40 = argmax(x37, x39)
    x41 = first(x40)
    x42 = last(x40)
    x43 = fill(I, x3, x7)
    x44 = shift(x42, x41)
    x45 = fill(x43, x11, x44)
    return x45
...
def verify_3618c87e(I: Grid) -> Grid:
    ...
    x27 = apply(first, x10)
    x28 = either(x15, x18)
    x29 = branch(x28, x26, x27)
    x30 = branch(x28, lbind, rbind)
    x31 = lbind(x30, astuple)
    x32 = branch(x28, height, width)
    x33 = x32(I)
    x34 = decrement(x33)
    x35 = either(x15, x22)
    x36 = branch(x35, ZERO, x34)
    x37 = x31(x36)
    x38 = apply(x37, x29)
    x39 = fill(x9, x5, x38)
    return x39
...
def verify_36d67576(I: Grid) -> Grid:
    ...
    x27 = compose(x22, x26)
    x28 = compose(initset, x17)
    x29 = chain(first, x21, x28)
    x30 = compose(invert, x29)
    x31 = fork(shift, x22, x30)
    x32 = compose(x19, x31)
    x33 = compose(x20, x27)
    x34 = fork(mapply, x32, x33)
    x35 = rbind(astuple, x34)
    x36 = compose(last, x35)
    x37 = rbind(astuple, x12)
    x38 = compose(last, x37)
    x39 = fork(mapply, x36, x38)
    x40 = fork(paint, identity, x39)
    x41 = sfilter(x1, x14)
    x42 = size(x41)
    x43 = equality(x42, ZERO)
    x44 = branch(x43, identity, x40)
    x45 = x44(I)
    return x45
...
def verify_3906de3d(I: Grid) -> Grid:
    ...
    x13 = size(x12)
    x14 = greater(x10, x13)
    x15 = branch(x14, hmirror, identity)
    x16 = x15(x5)
    x17 = partition(x16)
    x18 = matcher(color, x7)
    x19 = extract(x17, x18)
    x20 = remove(x19, x17)
    x21 = argmin(x20, uppermost)
    x22 = other(x20, x21)
    x23 = color(x21)
    x24 = color(x22)
    x25 = fill(x16, TWO, x19)
    x26 = fill(x25, ONE, x22)
    x27 = fill(x26, ZERO, x21)
    ...
    x35 = fill(x33, x7, x34)
    x36 = ofcolor(x33, ONE)
    x37 = fill(x35, x24, x36)
    x38 = ofcolor(x33, ZERO)
    x39 = fill(x37, x23, x38)
    return x39
...
def verify_39e1d7f9(I: Grid) -> Grid:
    ...
    x31 = divide(x26, x30)
    x32 = width(x0)
    x33 = sfilter(x27, vline)
    x34 = size(x33)
    x35 = increment(x34)
    x36 = divide(x32, x35)
    x37 = rbind(multiply, x36)
    x38 = rbind(divide, x36)
    x39 = compose(x37, x38)
    x40 = fork(equality, x39, identity)
    x41 = compose(x40, first)
    x42 = rbind(multiply, x31)
    x43 = rbind(divide, x31)
    x44 = compose(x42, x43)
    x45 = fork(equality, x44, identity)
    x46 = compose(x45, first)
    x47 = lbind(interval, ZERO)
    x48 = rbind(x47, ONE)
    x49 = compose(x48, size)
    x50 = fork(pair, x49, identity)
    x51 = lbind(apply, last)
    x52 = rbind(sfilter, x41)
    x53 = chain(x51, x52, x50)
    x54 = compose(x53, last)
    x55 = height(x25)
    x56 = interval(ZERO, x55, ONE)
    x57 = pair(x56, x25)
    x58 = sfilter(x57, x46)
    x59 = apply(x54, x58)
    x60 = increment(x36)
    x61 = hupscale(x59, x60)
    x62 = increment(x31)
    x63 = vupscale(x61, x62)
    x64 = merge(x27)
    x65 = paint(x63, x64)
    x66 = shape(I)
    x67 = crop(x65, ORIGIN, x66)
    return x67
...
def verify_3ac3eb23(I: Grid) -> Grid:
    ...
    x14 = interval(ONE, x12, TWO)
    x15 = rbind(apply, x13)
    x16 = lbind(rbind, astuple)
    x17 = chain(x15, x16, last)
    x18 = rbind(apply, x14)
    x19 = compose(increment, last)
    x20 = chain(x18, x16, x19)
    x21 = compose(decrement, last)
    x22 = chain(x18, x16, x21)
    x23 = fork(combine, x17, x20)
    x24 = fork(combine, x23, x22)
    x25 = compose(x24, center)
...
def verify_3e980e27(I: Grid) -> Grid:
    ...
    x17 = compose(x15, x14)
    x18 = chain(normalize, vmirror, x17)
    x19 = rbind(sfilter, x2)
    x20 = chain(ulcorner, x19, x16)
    x21 = rbind(sfilter, x3)
    x22 = chain(ulcorner, x21, x18)
    x23 = chain(center, x21, x17)
    x24 = lbind(lbind, shift)
    x25 = compose(x24, x16)
    x26 = compose(x24, x18)
    x27 = rbind(apply, x0)
    x28 = lbind(lbind, add)
    x29 = compose(invert, x20)
    x30 = chain(x27, x28, x29)
    x31 = rbind(remove, x1)
    x32 = compose(x31, x23)
    x33 = chain(x28, invert, x22)
    x34 = fork(apply, x33, x32)
    x35 = fork(mapply, x25, x30)
    x36 = fork(mapply, x26, x34)
    x37 = fork(paint, identity, x35)
    x38 = fork(paint, identity, x36)
    x39 = size(x0)
    x40 = positive(x39)
    x41 = size(x1)
    x42 = positive(x41)
    x43 = branch(x40, x37, identity)
    x44 = branch(x42, x38, identity)
    x45 = compose(x43, x44)
    x46 = x45(I)
    return x46
...
def verify_3eda0437(I: Grid) -> Grid:
    ...
    x29 = chain(x20, asindices, x21)
    x30 = lbind(lbind, shift)
    x31 = fork(mapply, x30, x19)
    x32 = compose(x31, x29)
    x33 = size(x26)
    x34 = positive(x33)
    x35 = lbind(recolor, SIX)
    x36 = lbind(mapply, x32)
    x37 = chain(x35, x36, x28)
    x38 = fork(difference, identity, identity)
    x39 = branch(x34, x37, x38)
    x40 = x39(x26)
    x41 = paint(I, x40)
    return x41
...
def verify_447fd412(I: Grid) -> Grid:
    ...
    x20 = recolor(x3, x19)
    x21 = combine(x17, x20)
    x22 = lbind(mfilter, x7)
    x23 = lbind(occurrences, x6)
    x24 = lbind(upscale, x21)
    x25 = compose(x23, x24)
    x26 = lbind(lbind, shift)
    x27 = lbind(upscale, x9)
    x28 = compose(x26, x27)
    x29 = fork(apply, x28, x25)
    x30 = compose(positive, size)
    x31 = lbind(chain, x30)
    x32 = rbind(x31, toindices)
    x33 = lbind(rbind, intersection)
    x34 = chain(x22, x32, x33)
    x35 = chain(size, x34, toindices)
    x36 = rbind(colorcount, x12)
    x37 = fork(equality, x35, x36)
    x38 = rbind(sfilter, x37)
    x39 = chain(merge, x38, x29)
    x40 = interval(ONE, SIX, ONE)
    x41 = mapply(x39, x40)
    x42 = paint(x6, x41)
    x43 = subgrid(x2, x42)
    return x43
...
def verify_4522001f(I: Grid) -> Grid:
    ...
    x20 = lbind(mapply, dneighbors)
    x21 = rbind(sfilter, x8)
    x22 = chain(x20, delta, x21)
    x23 = ineighbors(ORIGIN)
    ...
    x31 = fork(combine, identity, x30)
    x32 = compose(backdrop, x31)
    x33 = double(x12)
    x34 = decrement(x33)
    x35 = multiply(x34, FOUR)
    x36 = rbind(shift, x35)
    x37 = compose(x36, x32)
    x38 = fork(combine, x32, x37)
    x39 = mapply(x38, x19)
    x40 = fill(x18, x6, x39)
    return x40
...
def verify_50846271(I: Grid) -> Grid:
    ...
    x83 = tojvec(x74)
    x84 = rbind(add, x83)
    x85 = fork(connect, x82, x84)
    x86 = fork(combine, x80, x85)
    x87 = mapply(x86, x73)
    x88 = fill(x48, x0, x87)
    x89 = replace(x88, x0, EIGHT)
    x90 = fill(x89, x0, x1)
    return x90
...
def verify_5168d44c(I: Grid) -> Grid:
    ...
    x56 = delta(x55)
    x57 = ulcorner(x56)
    x58 = subtract(x49, x57)
    x59 = shift(x55, x58)
    x60 = combine(x59, x54)
    x61 = color(x11)
    x62 = replace(I, x61, x6)
    x63 = paint(x62, x60)
    return x63
...
def verify_57aa92db(I: Grid) -> Grid:
    ...
    x17 = chain(x16, width, x15)
    x18 = compose(ulcorner, x15)
    x19 = chain(ulcorner, x15, x17)
    x20 = fork(subtract, x18, x19)
    x21 = fork(shift, x17, x20)
    x22 = rbind(other, x7)
    x23 = compose(x22, palette)
    x24 = compose(x15, x21)
    x25 = fork(difference, x21, x24)
    x26 = fork(recolor, x23, x25)
...
def verify_5ad4f10b(I: Grid) -> Grid:
    ...
    x14 = fork(sfilter, x9, x12)
    x15 = compose(x13, x14)
    x16 = argmax(x5, x15)
    x17 = other(x5, x16)
    x18 = ofcolor(I, x16)
    x19 = subgrid(x18, I)
    x20 = switch(x19, x16, x17)
    x21 = replace(x20, x16, x3)
    x22 = lbind(downscale, x21)
    x23 = fork(upscale, x22, identity)
    x24 = matcher(x23, x21)
    x25 = shape(x21)
    x26 = maximum(x25)
...
def verify_5daaa586(I: Grid) -> Grid:
    ...
    x19 = compose(last, first)
    x20 = compose(last, last)
    x21 = fork(equality, x19, x20)
    x22 = fork(either, x18, x21)
    x23 = product(x13, x15)
    x24 = sfilter(x23, x22)
    x25 = fork(connect, first, last)
    x26 = mapply(x25, x24)
    x27 = fill(x7, x11, x26)
    return x27
...
def verify_673ef223(I: Grid) -> Grid:
    ...
    x14 = compose(x13, x3)
    x15 = chain(x12, minimum, x14)
    x16 = fork(both, x11, x15)
    x17 = fork(both, x5, x16)
    x18 = extract(x2, x17)
    x19 = other(x2, x18)
    x20 = ofcolor(I, x19)
    x21 = colorfilter(x0, x18)
    x22 = rbind(vmatching, x20)
    x23 = rbind(hmatching, x20)
    x24 = fork(either, x22, x23)
    x25 = extract(x21, x24)
    x26 = other(x21, x25)
    x27 = rbind(gravitate, x25)
    x28 = compose(x27, initset)
    x29 = fork(add, identity, x28)
    x30 = fork(connect, identity, x29)
    x31 = mapply(x30, x20)
    x32 = fill(I, x19, x31)
    x33 = fill(x32, FOUR, x20)
    x34 = ofcolor(I, x18)
    x35 = apply(first, x34)
    x36 = size(x35)
    x37 = apply(last, x34)
    x38 = size(x37)
    x39 = greater(x36, x38)
    x40 = compose(toivec, first)
    x41 = compose(tojvec, last)
    x42 = branch(x39, x40, x41)
    x43 = branch(x39, hfrontier, vfrontier)
    x44 = ulcorner(x25)
    x45 = ulcorner(x26)
    x46 = subtract(x45, x44)
    x47 = x42(x46)
    x48 = shift(x20, x47)
    x49 = mapply(x43, x48)
    x50 = fill(x33, x19, x49)
    x51 = fill(x50, x18, x34)
    return x51
...
def verify_6773b310(I: Grid) -> Grid:
    ...
    x18 = shape(x17)
    x19 = increment(x18)
    x20 = rbind(divide, x19)
    x21 = apply(x20, x16)
    x22 = sfilter(x0, hline)
    x23 = size(x22)
    x24 = sfilter(x0, vline)
    x25 = size(x24)
    x26 = astuple(x23, x25)
    x27 = increment(x26)
    x28 = canvas(x10, x27)
...
def verify_681b3aeb(I: Grid) -> Grid:
    ...
    x21 = fork(both, x20, x19)
    x22 = valmax(x1, height)
    x23 = valmax(x1, width)
...
def verify_6855a6e4(I: Grid) -> Grid:
    ...
    x45 = invert(x44)
    x46 = shift(x39, x45)
    x47 = fill(x19, x25, x26)
    x48 = combine(x38, x46)
    x49 = fill(x47, x24, x48)
    x50 = x18(x49)
    return x50
...
def verify_6a1e5592(I: Grid) -> Grid:
    ...
    x13 = compose(initset, x9)
    x14 = chain(first, x10, x13)
    x15 = matcher(x12, ONE)
    x16 = matcher(x14, x5)
    ...
    x32 = lowermost(x28)
    x33 = dneighbors(ORIGIN)
    x34 = remove(DOWN, x33)
    x35 = rbind(mapply, x34)
    x36 = lbind(chain, x35)
    x37 = lbind(lbind, add)
    x38 = rbind(x36, x37)
    x39 = lbind(lbind, compose)
    x40 = lbind(lbind, shift)
    x41 = chain(x38, x39, x40)
    x42 = lbind(chain, size)
    x43 = rbind(intersection, x28)
    x44 = lbind(x42, x43)
    x45 = rbind(matcher, ZERO)
    x46 = chain(x45, x44, x40)
    x47 = rbind(chain, first)
    x48 = rbind(x47, decrement)
    x49 = lbind(greater, x32)
    x50 = x48(x49)
    x51 = rbind(sfilter, x50)
    x52 = lbind(compose, x51)
    x53 = rbind(difference, x29)
    x54 = lbind(x42, x53)
    x55 = chain(x45, x54, x40)
    x56 = rbind(intersection, x29)
    x57 = lbind(x42, x56)
    x58 = lbind(fork, difference)
    x59 = compose(x52, x41)
    x60 = fork(x58, x59, x40)
    x61 = compose(x57, x60)
    x62 = compose(x45, x61)
    x63 = lbind(fork, both)
    x64 = fork(x63, x62, x55)
    x65 = fork(x63, x46, x64)
    x66 = compose(normalize, toindices)
    x67 = lbind(sfilter, x31)
    x68 = chain(x67, x65, x66)
    x69 = rbind(argmin, first)
    x70 = compose(x69, x68)
    x71 = fork(shift, x66, x70)
    x72 = mapply(x71, x27)
    x73 = merge(x27)
    x74 = cover(x20, x73)
    x75 = fill(x74, ONE, x72)
    x76 = x19(x75)
    return x76
...
def verify_6d0160f0(I: Grid) -> Grid:
    ...
    x25 = paint(x24, x1)
    x26 = normalize(x10)
    x27 = matcher(first, x2)
    x28 = compose(flip, x27)
    x29 = sfilter(x26, x28)
    x30 = shape(x26)
    x31 = increment(x30)
    x32 = matcher(first, FOUR)
    x33 = sfilter(x26, x32)
    x34 = center(x33)
    x35 = multiply(x31, x34)
    x36 = shift(x29, x35)
    x37 = paint(x25, x36)
    return x37
...
def verify_72322fa7(I: Grid) -> Grid:
    ...
    x12 = chain(invert, ulcorner, x9)
    x13 = chain(invert, ulcorner, x10)
    x14 = lbind(lbind, shift)
    x15 = fork(shift, identity, x12)
...
def verify_73251a56(I: Grid) -> Grid:
    ...
    x45 = paint(x44, x41)
    x46 = ofcolor(x45, x38)
    x47 = mapply(dneighbors, x46)
    x48 = difference(x47, x46)
    x49 = toobject(x48, x45)
    x50 = size(x49)
    x51 = positive(x50)
    x52 = rbind(astuple, x38)
    x53 = compose(last, x52)
    x54 = branch(x51, mostcolor, x53)
    x55 = x54(x49)
    x56 = replace(x45, x38, x55)
    return x56
...
def verify_77fdfe62(I: Grid) -> Grid:
    ...
    x23 = corners(x21)
    x24 = difference(x22, x23)
    x25 = toobject(x24, x20)
    x26 = color(x25)
    x27 = palette(x1)
    x28 = other(x27, x26)
    x29 = replace(x3, x28, x8)
    x30 = replace(x4, x28, x12)
    x31 = replace(x6, x28, x16)
    x32 = replace(x7, x28, x19)
    x33 = hconcat(x29, x30)
    x34 = hconcat(x31, x32)
    x35 = vconcat(x33, x34)
    return x35
...
def verify_82819916(I: Grid) -> Grid:
    ...
    x20 = toindices(x19)
    x21 = apply(first, x20)
    x22 = lbind(sfilter, x19)
    x23 = compose(first, last)
    x24 = lbind(matcher, x23)
    x25 = compose(x22, x24)
    x26 = apply(x25, x21)
    x27 = lbind(shift, x13)
    x28 = chain(x27, toivec, uppermost)
    x29 = matcher(first, x16)
    x30 = rbind(sfilter, x29)
    x31 = rbind(compose, last)
    x32 = lbind(rbind, contained)
    x33 = chain(toindices, x30, x28)
    x34 = chain(x31, x32, x33)
    x35 = fork(sfilter, identity, x34)
    x36 = compose(color, x35)
    x37 = compose(x30, x28)
    x38 = fork(recolor, x36, x37)
    x39 = fork(other, palette, x36)
    x40 = fork(difference, x28, x37)
    x41 = fork(recolor, x39, x40)
    x42 = fork(combine, x38, x41)
    x43 = mapply(x42, x26)
    x44 = paint(x5, x43)
    x45 = x4(x44)
    return x45
...
def verify_834ec97d(I: Grid) -> Grid:
    ...
    x8 = interval(x5, NEG_ONE, NEG_TWO)
    x9 = combine(x7, x8)
    x10 = rbind(shoot, UP)
    x11 = uppermost(x1)
...
def verify_8403a5d5(I: Grid) -> Grid:
    ...
    x8 = fill(I, x2, x7)
    x9 = increment(x3)
    x10 = interval(x9, x4, FOUR)
    x11 = add(x3, THREE)
    x12 = interval(x11, x4, FOUR)
    x13 = apply(tojvec, x10)
    x14 = height(I)
    x15 = decrement(x14)
    x16 = lbind(astuple, x15)
    x17 = apply(x16, x12)
    x18 = combine(x13, x17)
    x19 = fill(x8, FIVE, x18)
    return x19
...
def verify_8a004b2b(I: Grid) -> Grid:
    ...
    x39 = width(x34)
    x40 = divide(x38, x39)
    x41 = vupscale(x16, x37)
    x42 = hupscale(x41, x40)
    x43 = asobject(x42)
    x44 = sfilter(x43, x14)
    x45 = ulcorner(x15)
    x46 = sfilter(x44, x32)
    x47 = ulcorner(x46)
    x48 = subtract(x45, x47)
    x49 = shift(x44, x48)
    x50 = paint(I, x49)
    x51 = subgrid(x3, x50)
    return x51
...
def verify_8d510a79(I: Grid) -> Grid:
    ...
    x9 = ofcolor(I, TWO)
    x10 = ofcolor(I, ONE)
    x11 = rbind(gravitate, x8)
    x12 = compose(x11, initset)
    x13 = fork(add, identity, x12)
    x14 = fork(connect, identity, x13)
    x15 = shape(I)
    x16 = maximum(x15)
    x17 = lbind(multiply, x16)
    x18 = lbind(gravitate, x8)
    x19 = chain(x17, sign, x18)
    x20 = compose(x19, initset)
    x21 = fork(add, identity, x20)
    x22 = fork(connect, identity, x21)
    x23 = mapply(x14, x9)
...
def verify_8e1813be(I: Grid) -> Grid:
    ...
    x9 = greater(x6, x8)
    x10 = branch(x9, dmirror, identity)
    x11 = branch(x9, uppermost, leftmost)
    x12 = order(x4, x11)
    x13 = apply(color, x12)
    x14 = size(x4)
    x15 = repeat(x13, x14)
...
def verify_8e5a5113(I: Grid) -> Grid:
    ...
    x19 = compose(initset, x15)
    x20 = chain(first, x16, x19)
    x21 = compose(asobject, x18)
    x22 = uppermost(x11)
    x23 = lbind(add, x22)
    x24 = height(x11)
    x25 = increment(x24)
    x26 = lbind(multiply, x25)
    x27 = chain(toivec, x23, x26)
    x28 = fork(shift, x21, x27)
    x29 = compose(asobject, x20)
    x30 = lbind(subtract, x22)
    x31 = chain(toivec, x30, x26)
    x32 = fork(shift, x29, x31)
    x33 = fork(combine, x28, x32)
    x34 = mapply(x33, x13)
    x35 = paint(x3, x34)
    x36 = x2(x35)
...
def verify_90f3ed37(I: Grid) -> Grid:
    ...
    x10 = chain(size, x8, x7)
    x11 = lbind(sfilter, x1)
    x12 = lbind(compose, x10)
    x13 = chain(x11, x9, x12)
    x14 = lbind(fork, x6)
    x15 = compose(increment, minimum)
    x16 = lbind(lbind, astuple)
    x17 = lbind(chain, x15)
    x18 = rbind(x17, first)
    x19 = chain(x18, x16, first)
    x20 = lbind(chain, maximum)
    x21 = rbind(x20, first)
    x22 = chain(x21, x16, first)
    x23 = fork(x14, x19, x22)
    x24 = compose(x13, x23)
    x25 = apply(toivec, x2)
    x26 = apply(x24, x25)
    ...
    x38 = rbind(apply, x34)
    x39 = lbind(rbind, add)
    x40 = chain(x38, x39, center)
    x41 = compose(positive, size)
    x42 = lbind(compose, size)
    x43 = lbind(shift, x31)
    x44 = rbind(compose, x43)
    x45 = lbind(rbind, intersection)
    x46 = compose(x44, x45)
    x47 = lbind(compose, x41)
    x48 = compose(x47, x46)
    x49 = fork(sfilter, x40, x48)
    x50 = compose(x42, x46)
    x51 = fork(valmax, x49, x50)
    x52 = fork(matcher, x50, x51)
    x53 = fork(sfilter, x49, x52)
    x54 = lbind(insert, x37)
    x55 = lbind(rbind, greater)
    x56 = compose(x55, rightmost)
    x57 = compose(leftmost, x54)
    x58 = lbind(rbind, difference)
    x59 = compose(x44, x58)
    x60 = lbind(compose, x57)
    x61 = compose(x60, x59)
    x62 = fork(compose, x56, x61)
    x63 = fork(argmax, x53, x62)
    x64 = compose(x43, x63)
    x65 = fork(difference, x64, identity)
    x66 = mapply(x65, x28)
    x67 = fill(I, ONE, x66)
    return x67
...
def verify_91714a58(I: Grid) -> Grid:
    ...
    x7 = paint(x6, x3)
    x8 = color(x3)
    x9 = astuple(x5, ORIGIN)
    x10 = astuple(x8, RIGHT)
    x11 = astuple(x5, ZERO_BY_TWO)
    x12 = initset(x11)
    x13 = insert(x10, x12)
    x14 = insert(x9, x13)
    x15 = dmirror(x14)
    x16 = toindices(x14)
    x17 = lbind(shift, x16)
    x18 = occurrences(x7, x14)
    x19 = mapply(x17, x18)
    x20 = toindices(x15)
    x21 = lbind(shift, x20)
    x22 = occurrences(x7, x15)
    x23 = mapply(x21, x22)
    x24 = combine(x19, x23)
    x25 = fill(x7, x5, x24)
    return x25
...
def verify_941d9a10(I: Grid) -> Grid:
    ...
    x12 = rbind(compose, uppermost)
    x13 = chain(size, x9, x12)
    x14 = lbind(lbind, greater)
    x15 = chain(x11, x14, leftmost)
    x16 = lbind(rbind, greater)
    x17 = chain(x11, x16, leftmost)
    x18 = chain(x13, x14, uppermost)
    x19 = chain(x13, x16, uppermost)
    x20 = fork(equality, x15, x17)
    x21 = fork(equality, x18, x19)
    x22 = fork(both, x20, x21)
    x23 = extract(x5, x22)
    x24 = fill(I, ONE, x7)
    x25 = fill(x24, THREE, x8)
    x26 = fill(x25, TWO, x23)
    return x26
...
def verify_97a05b5b(I: Grid) -> Grid:
    ...
    x36 = chain(first, x23, asobject)
    x37 = lbind(argmax, x17)
    x38 = compose(x37, x35)
    x39 = compose(initset, x38)
    x40 = fork(rapply, x39, x20)
    x41 = compose(first, x40)
    x42 = fork(rapply, x39, x30)
    x43 = compose(first, x42)
    x44 = compose(asobject, x41)
    x45 = compose(x36, x43)
    x46 = fork(shift, x44, x45)
    x47 = mapply(x46, x5)
    x48 = paint(x10, x47)
    return x48
...
def verify_9d9215db(I: Grid) -> Grid:
    ...
    x11 = combine(x10, x8)
    x12 = paint(I, x11)
    x13 = compose(increment, first)
    x14 = fork(greater, last, x13)
    x15 = tojvec(NEG_TWO)
    x16 = rbind(shift, x15)
    x17 = compose(x16, vmirror)
    x18 = rbind(sfilter, x14)
    x19 = compose(x18, asindices)
    x20 = compose(x17, x19)
    ...
    x27 = compose(double, halve)
    x28 = fork(equality, x27, identity)
    x29 = chain(flip, x28, last)
    x30 = lbind(fork, both)
    x31 = rbind(x30, x29)
    x32 = lbind(fork, recolor)
    x33 = lbind(x32, first)
    x34 = rbind(compose, x23)
    x35 = lbind(rbind, contained)
    x36 = lbind(rbind, sfilter)
    x37 = chain(x33, x34, x36)
    x38 = chain(x37, x31, x35)
    x39 = fork(toobject, x21, identity)
    x40 = compose(x26, x39)
    x41 = compose(x38, x21)
    x42 = fork(mapply, x41, x40)
...
def verify_9dfd6313(I: Grid) -> Grid:
    ...
    x16 = astuple(x4, x14)
    x17 = connect(x15, x16)
    x18 = astuple(x2, dmirror)
    x19 = astuple(x9, cmirror)
    x20 = astuple(x18, x19)
    x21 = astuple(x17, vmirror)
    x22 = astuple(x13, hmirror)
    x23 = astuple(x21, x22)
    x24 = combine(x20, x23)
    x25 = lbind(colorcount, I)
    x26 = rbind(toobject, I)
    x27 = compose(x26, first)
    x28 = chain(x25, color, x27)
    x29 = compose(size, first)
    x30 = fork(equality, x28, x29)
    x31 = chain(numcolors, x26, first)
    x32 = matcher(x31, ONE)
...
def verify_a3df8b1e(I: Grid) -> Grid:
    ...
    x33 = urcorner(x3)
    x34 = index(x2, x33)
    x35 = equality(x34, x29)
    x36 = llcorner(x3)
    x37 = index(x2, x36)
    x38 = equality(x37, x29)
    x39 = lrcorner(x3)
    x40 = index(x2, x39)
    x41 = equality(x40, x29)
    x42 = astuple(x32, x35)
    x43 = astuple(x38, x41)
    x44 = combine(x42, x43)
    x45 = vmirror(x22)
...
def verify_a61ba2ce(I: Grid) -> Grid:
    ...
    x23 = paint(x21, x22)
    x24 = normalize(x6)
    x25 = subtract(x18, x17)
    x26 = tojvec(x25)
    x27 = shift(x24, x26)
    x28 = paint(x23, x27)
    x29 = normalize(x9)
    x30 = subtract(x15, x14)
    x31 = toivec(x30)
    x32 = shift(x29, x31)
    x33 = paint(x28, x32)
    x34 = normalize(x12)
    x35 = shape(x12)
    x36 = subtract(x19, x35)
    x37 = shift(x34, x36)
    x38 = paint(x33, x37)
    return x38
...
def verify_a65b410d(I: Grid) -> Grid:
    ...
    x20 = ofcolor(x19, x7)
    x21 = argmax(x20, last)
    x22 = add(x21, UP_RIGHT)
    x23 = shoot(x22, UP_RIGHT)
    x24 = add(x21, DOWN_LEFT)
    x25 = shoot(x24, DOWN_LEFT)
    x26 = rbind(shoot, LEFT)
    x27 = mapply(x26, x23)
    x28 = mapply(x26, x25)
    x29 = width(x19)
    x30 = invert(x29)
    ...
    x32 = shift(x27, x31)
    x33 = combine(x27, x32)
    x34 = fill(x19, THREE, x33)
    x35 = shift(x28, x31)
    x36 = combine(x28, x35)
    x37 = fill(x34, ONE, x36)
    x38 = x18(x37)
    return x38
...
def verify_a8c38be5(I: Grid) -> Grid:
    ...
    x42 = matcher(x41, ONE)
    x43 = compose(x38, uppermost)
    x44 = fork(sfilter, toindices, x43)
    x45 = compose(size, x44)
    x46 = matcher(x45, ONE)
    x47 = lbind(matcher, last)
    x48 = compose(x47, rightmost)
    x49 = fork(sfilter, toindices, x48)
    x50 = compose(size, x49)
    x51 = matcher(x50, ONE)
    x52 = compose(x47, leftmost)
    x53 = fork(sfilter, toindices, x52)
    x54 = compose(size, x53)
    x55 = matcher(x54, ONE)
    x56 = fork(both, x34, x42)
    x57 = fork(both, x35, x46)
    x58 = fork(both, x36, x51)
    x59 = fork(both, x37, x55)
    x60 = fork(difference, x10, toindices)
    x61 = compose(size, x60)
    x62 = matcher(x61, ZERO)
    x63 = fork(difference, x19, toindices)
    x64 = compose(size, x63)
    x65 = matcher(x64, ZERO)
    x66 = fork(difference, x11, toindices)
    x67 = compose(size, x66)
    x68 = matcher(x67, ZERO)
    x69 = fork(difference, x15, toindices)
    x70 = compose(size, x69)
    x71 = matcher(x70, ZERO)
    x72 = fork(both, x62, x56)
    x73 = fork(both, x65, x57)
    x74 = fork(both, x68, x58)
    x75 = fork(both, x71, x59)
    x76 = argmax(x9, x13)
    x77 = argmax(x9, x17)
    x78 = argmax(x9, x21)
    x79 = argmax(x9, x25)
    ...
    x100 = canvas(x98, x99)
    x101 = normalize(x76)
    x102 = paint(x100, x101)
    x103 = normalize(x77)
    x104 = subtract(x95, x91)
    x105 = tojvec(x104)
    x106 = shift(x103, x105)
    x107 = paint(x102, x106)
    x108 = normalize(x78)
    x109 = subtract(x89, x85)
    x110 = toivec(x109)
    x111 = shift(x108, x110)
    x112 = paint(x107, x111)
    x113 = normalize(x79)
    x114 = height(x79)
    x115 = subtract(x89, x114)
    x116 = width(x79)
    x117 = subtract(x95, x116)
    x118 = astuple(x115, x117)
    x119 = shift(x113, x118)
    x120 = paint(x112, x119)
    x121 = normalize(x82)
    x122 = increment(x84)
    x123 = toivec(x122)
    x124 = shift(x121, x123)
    x125 = paint(x120, x124)
    x126 = normalize(x80)
    x127 = increment(x90)
    x128 = tojvec(x127)
    x129 = shift(x126, x128)
    x130 = paint(x125, x129)
    x131 = normalize(x83)
    x132 = height(x77)
    x133 = increment(x132)
    x134 = width(x83)
    x135 = subtract(x95, x134)
    x136 = astuple(x133, x135)
    x137 = shift(x131, x136)
    x138 = paint(x130, x137)
    x139 = normalize(x81)
    x140 = height(x81)
    x141 = subtract(x89, x140)
    x142 = width(x78)
    x143 = increment(x142)
    x144 = astuple(x141, x143)
    x145 = shift(x139, x144)
    x146 = paint(x138, x145)
    return x146
...
def verify_aba27056(I: Grid) -> Grid:
    ...
    x20 = llcorner(x5)
    x21 = lrcorner(x5)
    x22 = branch(x14, x20, x21)
    x23 = branch(x11, x19, x22)
    x24 = branch(x8, x18, x23)
    x25 = branch(x14, x21, x18)
    x26 = branch(x11, x20, x25)
    x27 = branch(x8, x19, x26)
    x28 = branch(x14, DOWN_LEFT, UNITY)
    x29 = branch(x11, NEG_UNITY, x28)
    x30 = branch(x8, UP_RIGHT, x29)
    x31 = branch(x14, UNITY, UP_RIGHT)
    x32 = branch(x11, DOWN_LEFT, x31)
    x33 = branch(x8, NEG_UNITY, x32)
    x34 = branch(x14, DOWN, RIGHT)
    x35 = branch(x11, LEFT, x34)
    x36 = branch(x8, UP, x35)
    x37 = shoot(x24, x30)
    x38 = shoot(x27, x33)
    x39 = combine(x37, x38)
    x40 = rbind(shoot, x36)
...
def verify_b782dc8a(I: Grid) -> Grid:
    ...
    x13 = initset(x12)
    x14 = objects(I, T, F, F)
    x15 = colorfilter(x14, x11)
    x16 = lbind(adjacent, x7)
    x17 = mfilter(x15, x16)
    x18 = toindices(x17)
    x19 = rbind(manhattan, x13)
    x20 = chain(even, x19, initset)
    x21 = sfilter(x18, x20)
    x22 = fill(I, x4, x18)
    x23 = fill(x22, x0, x21)
    return x23
...
def verify_bc1d5164(I: Grid) -> Grid:
    ...
    x26 = rbind(sfilter, x25)
    x27 = chain(toindices, x26, normalize)
    x28 = x27(x11)
    x29 = x27(x15)
    x30 = x27(x19)
    x31 = x27(x22)
...
def verify_c3f564a4(I: Grid) -> Grid:
    ...
    x27 = increment(x26)
    x28 = invert(x25)
    x29 = interval(x28, x25, ONE)
    x30 = invert(x27)
    x31 = interval(x30, x27, ONE)
    x32 = product(x29, x31)
    x33 = astuple(x9, x4)
    x34 = lbind(multiply, x33)
    x35 = apply(x34, x32)
...
def verify_c8cbb738(I: Grid) -> Grid:
    ...
    x11 = center(x6)
    x12 = initset(x11)
    x13 = lbind(manhattan, x12)
    x14 = lbind(multiply, x10)
    x15 = lbind(intersection, x8)
    x16 = chain(x14, size, x15)
    x17 = lbind(fork, subtract)
    x18 = lbind(chain, x16)
    x19 = lbind(x18, toindices)
...
def verify_caa06a1f(I: Grid) -> Grid:
    ...
    x42 = equality(x41, x3)
    x43 = flip(x42)
    x44 = multiply(x31, LEFT)
    x45 = multiply(x35, UP)
    x46 = add(x44, x45)
    x47 = multiply(x39, RIGHT)
    x48 = multiply(x43, DOWN)
    x49 = add(x47, x48)
    x50 = add(x46, x49)
    x51 = shift(x28, x50)
    x52 = paint(I, x51)
...
def verify_cbded52d(I: Grid) -> Grid:
    ...
    x8 = height(I)
    x9 = increment(x8)
    x10 = sfilter(x0, hline)
    x11 = size(x10)
    x12 = increment(x11)
    x13 = divide(x9, x12)
    x14 = width(I)
    x15 = increment(x14)
    x16 = sfilter(x0, vline)
    x17 = size(x16)
    x18 = increment(x17)
    x19 = divide(x15, x18)
    x20 = rbind(multiply, x13)
    x21 = rbind(divide, x13)
    x22 = compose(x20, x21)
    x23 = fork(equality, identity, x22)
    x24 = rbind(multiply, x19)
    x25 = rbind(divide, x19)
    x26 = compose(x24, x25)
    x27 = fork(equality, identity, x26)
    x28 = lbind(fork, both)
    x29 = rbind(compose, first)
    x30 = lbind(compose, x23)
    x31 = lbind(rbind, subtract)
    x32 = compose(x31, uppermost)
    x33 = chain(x29, x30, x32)
    x34 = rbind(compose, last)
    x35 = lbind(compose, x27)
    x36 = compose(x31, leftmost)
    x37 = chain(x34, x35, x36)
    x38 = fork(x28, x33, x37)
    x39 = fork(sfilter, identity, x38)
    x40 = fork(connect, first, last)
    x41 = lbind(apply, x40)
    x42 = lbind(ofcolor, I)
    x43 = fork(product, x42, x42)
    x44 = fork(either, vline, hline)
    x45 = rbind(sfilter, x44)
    x46 = chain(x45, x41, x43)
    x47 = lbind(mapply, x39)
    x48 = compose(x47, x46)
    x49 = fork(recolor, identity, x48)
    x50 = mapply(x49, x7)
    x51 = paint(I, x50)
    return x51
...
def verify_cdecee7f(I: Grid) -> Grid:
    ...
    x19 = merge(x18)
    x20 = crop(x19, ORIGIN, x6)
    x21 = crop(x19, DOWN, x6)
    x22 = crop(x19, TWO_BY_ZERO, x6)
    x23 = vmirror(x21)
    x24 = vconcat(x20, x23)
    x25 = vconcat(x24, x22)
    return x25
...
def verify_d06dbe63(I: Grid) -> Grid:
    ...
    x25 = rbind(shift, x7)
    x26 = chain(x17, x25, x24)
    x27 = fork(paint, x20, x26)
    x28 = compose(rot180, x27)
    ...
    x35 = canvas(x33, x34)
    x36 = lbind(paint, x35)
    x37 = lbind(recolor, x31)
    x38 = chain(x36, x37, initset)
    x39 = compose(x30, x38)
    x40 = mapply(x39, x32)
    x41 = fill(I, FIVE, x40)
    x42 = fill(x41, x31, x32)
    return x42
...
def verify_d07ae81c(I: Grid) -> Grid:
    ...
    x27 = mapply(x25, x26)
    x28 = ofcolor(I, x14)
    x29 = intersection(x28, x27)
    x30 = ofcolor(I, x18)
    x31 = intersection(x30, x27)
    x32 = fill(I, x9, x29)
    x33 = fill(x32, x10, x31)
    return x33
...
def verify_d687bc17(I: Grid) -> Grid:
    ...
    x17 = sfilter(x3, x16)
    x18 = lbind(colorfilter, x9)
    x19 = chain(first, x18, color)
    x20 = fork(gravitate, identity, x19)
...
def verify_d90796e8(I: Grid) -> Grid:
    ...
    x5 = lbind(intersection, x0)
    x6 = chain(x2, x5, dneighbors)
    x7 = sfilter(x0, x4)
    x8 = sfilter(x1, x6)
    x9 = cover(I, x7)
...
def verify_db3e9e38(I: Grid) -> Grid:
    ...
    x18 = invert(x16)
    x19 = astuple(NEG_TWO, x18)
    x20 = multiply(THREE, TEN)
    x21 = interval(ZERO, x20, ONE)
    x22 = lbind(multiply, x13)
    x23 = apply(x22, x21)
    x24 = lbind(multiply, x15)
    x25 = apply(x24, x21)
    x26 = lbind(multiply, x17)
    x27 = apply(x26, x21)
    x28 = lbind(multiply, x19)
    x29 = apply(x28, x21)
    x30 = lbind(shift, x11)
    x31 = mapply(x30, x23)
    x32 = mapply(x30, x25)
...
def verify_ddf7fa4f(I: Grid) -> Grid:
    ...
    x14 = toobject(x13, I)
    x15 = mostcolor(x14)
    x16 = matcher(color, x15)
    x17 = compose(flip, x16)
    x18 = rbind(sfilter, x17)
    x19 = rbind(sizefilter, ONE)
    x20 = rbind(objects, F)
    x21 = rbind(x20, F)
    x22 = rbind(x21, T)
    x23 = rbind(subgrid, I)
    x24 = chain(x18, x22, x23)
    x25 = chain(size, x19, x24)
    x26 = astuple(x3, x7)
    x27 = astuple(x10, x11)
    x28 = combine(x26, x27)
    x29 = argmax(x28, x25)
    ...
    x34 = apply(x31, x33)
    x35 = rbind(intersection, x29)
    x36 = chain(size, x35, toindices)
    x37 = matcher(x36, ZERO)
    x38 = objects(I, T, F, T)
    x39 = sfilter(x38, x37)
    x40 = lbind(fork, either)
    x41 = lbind(lbind, hmatching)
    x42 = lbind(lbind, vmatching)
    x43 = fork(x40, x41, x42)
    x44 = lbind(chain, size)
    x45 = rbind(x44, x43)
    x46 = lbind(lbind, sfilter)
    x47 = compose(last, last)
    x48 = chain(x45, x46, x47)
    x49 = rbind(compose, x43)
    x50 = lbind(lbind, extract)
    x51 = chain(x49, x50, x47)
    x52 = compose(first, last)
    x53 = rbind(matcher, ONE)
    x54 = compose(x53, x48)
    x55 = fork(sfilter, x52, x54)
    x56 = lbind(fork, recolor)
    x57 = lbind(x56, color)
    x58 = compose(x57, x51)
    x59 = fork(mapply, x58, x55)
    x60 = fork(combine, first, x59)
    x61 = fork(difference, x52, x55)
    x62 = fork(apply, x51, x55)
    x63 = fork(difference, x47, x62)
    x64 = fork(astuple, x61, x63)
    x65 = fork(astuple, x60, x64)
    x66 = difference(x34, x34)
    x67 = power(x65, TEN)
    x68 = astuple(x34, x39)
    x69 = astuple(x66, x68)
    x70 = x67(x69)
...
def verify_de1cd16c(I: Grid) -> Grid:
    ...
    x10 = branch(x6, x7, x9)
    x11 = x10(x0)
    x12 = colorfilter(x0, x11)
    x13 = difference(x0, x12)
    x14 = rbind(subgrid, I)
    x15 = apply(x14, x13)
    x16 = rbind(colorcount, x11)
    x17 = argmax(x15, x16)
    x18 = mostcolor(x17)
...
def verify_e21d9049(I: Grid) -> Grid:
    ...
    x13 = objects(I, F, T, T)
    x14 = size(x13)
    x15 = equality(x14, TWO)
    x16 = mfilter(x13, hline)
    x17 = mfilter(x13, vline)
    x18 = branch(x15, x16, x10)
    x19 = branch(x15, x17, x12)
    x20 = width(x18)
    ...
    x39 = apply(x33, x38)
    x40 = apply(invert, x39)
    x41 = combine(x39, x40)
    x42 = apply(toivec, x41)
    x43 = lbind(shift, x19)
    x44 = mapply(x43, x42)
    x45 = combine(x31, x44)
    x46 = paint(I, x45)
...
def verify_e40b9e2f(I: Grid) -> Grid:
    ...
    x55 = lbind(rbind, astuple)
    x56 = compose(x37, x55)
    x57 = fork(x41, x54, x56)
    x58 = fork(mapply, x57, x20)
    x59 = center(x1)
    x60 = astuple(x59, ONE)
    x61 = repeat(x60, ONE)
    x62 = mapply(x58, x7)
    x63 = combine(x61, x62)
    x64 = valmax(x63, last)
    x65 = matcher(last, x64)
    x66 = sfilter(x63, x65)
    x67 = initset(x59)
    x68 = rbind(manhattan, x67)
    x69 = compose(halve, last)
    x70 = fork(add, first, x69)
    x71 = compose(initset, x70)
    x72 = compose(x68, x71)
    x73 = argmin(x66, x72)
    x74 = first(x73)
    x75 = last(x73)
    ...
    x90 = fgpartition(x89)
    x91 = merge(x90)
    x92 = occurrences(x83, x82)
    x93 = first(x92)
    x94 = invert(x93)
    x95 = shift(x85, x94)
    x96 = shift(x95, x74)
    x97 = occurrences(x86, x82)
    x98 = first(x97)
    x99 = invert(x98)
    x100 = shift(x88, x99)
    x101 = shift(x100, x74)
    x102 = occurrences(x89, x82)
    x103 = first(x102)
    x104 = invert(x103)
    x105 = shift(x91, x104)
    x106 = shift(x105, x74)
    x107 = combine(x96, x101)
    x108 = combine(x107, x106)
    x109 = paint(I, x108)
    return x109
...
def verify_e9afcf9a(I: Grid) -> Grid:
    ...
    x10 = fork(astuple, x9, x6)
    x11 = fork(astuple, first, x10)
    x12 = apply(x11, x8)
    x13 = paint(I, x12)
    return x13
...
def verify_ecdecbb3(I: Grid) -> Grid:
    ...
    x48 = rbind(x47, x41)
    x49 = compose(x48, x42)
    x50 = compose(initset, x49)
    x51 = fork(rapply, x50, identity)
    x52 = compose(first, x51)
    x53 = mapply(x52, x5)
    x54 = fill(I, x0, x53)
    x55 = intersection(x39, x53)
    x56 = mapply(neighbors, x55)
    x57 = fill(x54, x4, x56)
    return x57
...
def verify_f1cefba8(I: Grid) -> Grid:
    ...
    x15 = combine(x13, x14)
    x16 = mapply(x11, x15)
    x17 = difference(x12, x16)
    x18 = toindices(x2)
    x19 = intersection(x17, x18)
    x20 = fill(I, x6, x19)
    x21 = difference(x17, x19)
    x22 = fill(x20, x7, x21)
    x23 = fill(x22, x7, x9)
    return x23
...
def verify_f8c80d96(I: Grid) -> Grid:
    ...
    x34 = compose(x32, x33)
    x35 = lbind(add, x28)
    x36 = chain(initset, x35, x33)
    x37 = fork(insert, x34, x36)
    x38 = compose(box, x37)
    x39 = mapply(x38, x31)
    x40 = fill(I, x5, x39)
    x41 = replace(x40, x3, FIVE)
    return x41
...
def verify_fcb5c309(I: Grid) -> Grid:
    ...
    x11 = compose(x10, x5)
    x12 = fork(both, x6, x11)
    x13 = palette(I)
    x14 = extract(x13, x12)
    x15 = remove(x14, x13)
    x16 = lbind(colorcount, I)
    x17 = argmin(x15, x16)
    x18 = rbind(colorcount, x17)
    x19 = rbind(toobject, I)
    x20 = chain(x18, x19, backdrop)
    x21 = colorfilter(x0, x14)
    x22 = argmax(x21, x20)
    x23 = subgrid(x22, I)
    x24 = replace(x23, x14, x17)
    return x24
...
def verify_ff805c23(I: Grid) -> Grid:
    ...
    x23 = compose(vmirror, x22)
    x24 = fork(rapply, x18, x23)
    ...
    x31 = fork(both, x27, x28)
    x32 = fork(both, x29, x30)
