...
def verify_05269061(I: Grid) -> Grid:
    ...
    x16 = chain(x4, x11, x15)
    x17 = apply(x12, x2)
    x18 = apply(x16, x3)
    x19 = combine(x17, x18)
    x20 = rbind(shoot, NEG_UNITY)
    x23 = chain(x4, x20, x15)
    x26 = rbind(astuple, x14)
    x27 = lbind(subtract, x14)
    x28 = compose(x26, x27)
    x29 = chain(x4, x20, x28)
    x30 = apply(x23, x2)
    x31 = apply(x29, x3)
    x32 = combine(x30, x31)
...
def verify_2dd70a9a(I: Grid) -> Grid:
    ...
    x58 = lbind(connect, x6)
    x59 = corners(x54)
    x60 = apply(x58, x59)
    x61 = mfilter(x60, x57)
    x62 = lbind(connect, x8)
    x64 = apply(x62, x59)
    x65 = mfilter(x64, x57)
    x66 = combine(x61, x65)
    x67 = combine(x54, x66)
...
def verify_36d67576(I: Grid) -> Grid:
    ...
    x32 = chain(first, x21, x31)
    x33 = compose(invert, x32)
    x34 = fork(shift, x22, x33)
    x35 = compose(x19, x34)
    x36 = compose(x20, x27)
...
def verify_3eda0437(I: Grid) -> Grid:
    ...
    x31 = chain(x20, asindices, x21)
    x32 = lbind(lbind, shift)
    x34 = fork(mapply, x32, x19)
    x35 = compose(x34, x31)
    x36 = size(x26)
    x37 = positive(x36)
...
def verify_80af3007(I: Grid) -> Grid:
    ...
    x11 = height(x6)
    x12 = matcher(x7, x11)
    x14 = interval(ONE, x8, ONE)
    x15 = extract(x14, x9)
    x17 = interval(ONE, x11, ONE)
    x18 = extract(x17, x12)
    x20 = interval(ZERO, x8, ONE)
...
def verify_834ec97d(I: Grid) -> Grid:
    ...
    x9 = interval(x5, NEG_ONE, NEG_TWO)
    x10 = combine(x7, x9)
    x11 = rbind(shoot, UP)
    x12 = uppermost(x1)
...
def verify_8403a5d5(I: Grid) -> Grid:
    ...
    x8 = fill(I, x2, x7)
    x9 = increment(x3)
    x11 = interval(x9, x4, FOUR)
    x12 = add(x3, THREE)
    x14 = interval(x12, x4, FOUR)
...
def verify_8e5a5113(I: Grid) -> Grid:
    ...
    x32 = lbind(subtract, x23)
    x36 = chain(toivec, x32, x27)
...
def verify_91714a58(I: Grid) -> Grid:
    ...
    x7 = paint(x6, x3)
    x9 = color(x3)
    x10 = astuple(x5, ORIGIN)
    x11 = astuple(x9, RIGHT)
    x12 = astuple(x5, ZERO_BY_TWO)
    x13 = initset(x12)
    x14 = insert(x11, x13)
    x15 = insert(x10, x14)
    x16 = dmirror(x15)
...
def verify_a61ba2ce(I: Grid) -> Grid:
    ...
    x23 = paint(x21, x22)
    x24 = normalize(x6)
    x26 = subtract(x18, x17)
    x27 = tojvec(x26)
    x28 = shift(x24, x27)
    x29 = paint(x23, x28)
    x30 = normalize(x9)
    x32 = subtract(x15, x14)
    x33 = toivec(x32)
    x34 = shift(x30, x33)
    x35 = paint(x29, x34)
    x36 = normalize(x12)
...
def verify_a8c38be5(I: Grid) -> Grid:
    ...
    x63 = fork(difference, x10, toindices)
    x64 = compose(size, x63)
    x65 = matcher(x64, ZERO)
    x67 = fork(difference, x19, toindices)
    x68 = compose(size, x67)
    x69 = matcher(x68, ZERO)
    x71 = fork(difference, x11, toindices)
    x72 = compose(size, x71)
    x73 = matcher(x72, ZERO)
    x75 = fork(difference, x15, toindices)
    ...
    x109 = normalize(x83)
    x111 = subtract(x101, x97)
    x112 = tojvec(x111)
    x113 = shift(x109, x112)
    x114 = paint(x108, x113)
    x115 = normalize(x84)
    x117 = subtract(x95, x91)
    x118 = toivec(x117)
...
def verify_cbded52d(I: Grid) -> Grid:
    ...
    x8 = height(I)
    x9 = increment(x8)
    x11 = sfilter(x0, hline)
    x12 = size(x11)
    x13 = increment(x12)
    x14 = divide(x9, x13)
    x15 = width(I)
    x16 = increment(x15)
    x18 = sfilter(x0, vline)
    x19 = size(x18)
    x20 = increment(x19)
    x21 = divide(x16, x20)
...
def verify_ddf7fa4f(I: Grid) -> Grid:
    ...
    x71 = fork(difference, x61, x64)
    x73 = fork(apply, x60, x64)
    x74 = fork(difference, x55, x73)
...
def verify_e40b9e2f(I: Grid) -> Grid:
    ...
    x92 = fgpartition(x91)
    x93 = merge(x92)
    x95 = occurrences(x85, x84)
    x96 = first(x95)
    x97 = invert(x96)
    x98 = shift(x87, x97)
    x99 = shift(x98, x76)
    x101 = occurrences(x88, x84)
    x102 = first(x101)
    x103 = invert(x102)
    x104 = shift(x90, x103)
    x105 = shift(x104, x76)
    x107 = occurrences(x91, x84)
    x108 = first(x107)
    x109 = invert(x108)
    x110 = shift(x93, x109)
    x111 = shift(x110, x76)
